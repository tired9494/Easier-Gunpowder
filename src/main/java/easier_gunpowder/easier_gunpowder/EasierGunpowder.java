package easier_gunpowder.easier_gunpowder;
...
public class EasierGunpowder implements ModInitializer {
    ...
    public static final Block CHARCOAL_BLOCK = new Block(FabricBlockSettings.of(Material.STONE).hardness(5.0F).resistance(6.0F).materialColor(MaterialColor.BLACK).breakByHand(false).breakByTool(FabricToolTags.PICKAXES).requiresTool());
    public static final Block CHARCOAL_BLOCK_CRACKED = new Block(FabricBlockSettings.of(Material.STONE).hardness(1.5F).resistance(4.0F).materialColor(MaterialColor.BLACK).breakByHand(false).breakByTool(FabricToolTags.PICKAXES).requiresTool());
